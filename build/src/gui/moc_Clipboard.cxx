...
void Clipboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->clearClipboard(); break;
...
const QMetaObjectExtraData Clipboard::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Clipboard::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Clipboard,
      qt_meta_data_Clipboard, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Clipboard::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Clipboard))
