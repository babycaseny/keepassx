...
const QMetaObjectExtraData EditGroupWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject EditGroupWidget::staticMetaObject = {
    { &EditWidget::staticMetaObject, qt_meta_stringdata_EditGroupWidget,
      qt_meta_data_EditGroupWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &EditGroupWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EditGroupWidget))
